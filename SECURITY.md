...
will confirm the issue, coordinate a fix and release, and agree on disclosure
timing with the reporter. Please allow a reasonable remediation period before
public disclosure.
