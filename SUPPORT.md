...
- The citewire and Node.js versions
- The transport in use
- A minimal configuration with secrets and private URLs removed
- Exact reproduction steps
- Expected and actual behavior
- Relevant logs with credentials and third-party content removed

Support is provided on a best-effort basis. The project does not guarantee a
response time.
